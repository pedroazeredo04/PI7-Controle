...
extern long convertToReal(unsigned char* chars);
extern void printReal( long value);
# 25 "tasks.c" 2
...
void initTasks(void) {
   ...
   createTask(0, &pid_task, 6);
   createTask(1, &protocol_task, 1);
   createTask(2, &led_task, 2000);
}
