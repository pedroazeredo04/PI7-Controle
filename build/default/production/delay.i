...
void DelayBigUs(unsigned int cnt)
{
 ...
 {
  i--;
  { delayus_variable=(unsigned char)(253/1); __asm("nop"); __asm("nop"); } __asm("decfsz _delayus_variable,f"); __asm("goto $ - 3");;
  __asm("clrwdt");
 }
 { delayus_variable=(unsigned char)((unsigned char)(cnt & 0xFF)/1); __asm("nop"); __asm("nop"); } __asm("decfsz _delayus_variable,f"); __asm("goto $ - 3");;
}
...
void DelayMs(unsigned char cnt)
{
 ...
 do {
  i = 4;
  do {
   { delayus_variable=(unsigned char)(250/1); __asm("nop"); __asm("nop"); } __asm("decfsz _delayus_variable,f"); __asm("goto $ - 3");;
   __asm("clrwdt");
  } while(--i);
 } while(--cnt);
}
